...
if command -v "inkscape" && command -v "icotool" && command -v "oxipng"; then
    ...
    svg2png ${LAUNCHER_APPID}.svg "$d/majnrujlauncher_16.png" 16 16
    svg2png ${LAUNCHER_APPID}.svg "$d/majnrujlauncher_24.png" 24 24
    svg2png ${LAUNCHER_APPID}.svg "$d/majnrujlauncher_32.png" 32 32
    svg2png ${LAUNCHER_APPID}.svg "$d/majnrujlauncher_48.png" 48 48
    svg2png ${LAUNCHER_APPID}.svg "$d/majnrujlauncher_64.png" 64 64
    svg2png ${LAUNCHER_APPID}.svg "$d/majnrujlauncher_128.png" 128 128
    svg2png ${LAUNCHER_APPID}.svg "$d/majnrujlauncher_256.png" 256 256
